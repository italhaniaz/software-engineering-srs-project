...
\begin{tikzpicture}[every node/.style={font=\sffamily}, >=stealth, scale=0.95, transform shape]
	...
	\umlcompo{System}{QuestionBank}
	\umlcompo{System}{PaperGenerator}

	\umlassoc{PaperGenerator}{Database}

	\umldep{PaperGenerator}{ExportModule}
...
\begin{center}
	\begin{tikzpicture}[scale=1, transform shape]
		...
		% Relationships
	\umluniassoc{Teacher}{QuestionBank} % Teacher manages QuestionBank
	\umlcompo{QuestionBank}{Question}   % QuestionBank contains Questions
	\umlassoc{QuestionBank}{Database}   % QuestionBank interacts with Database
...
\begin{center}
	\begin{tikzpicture}[scale=1, transform shape]
		...
		% Relationships
		\umluniassoc{Teacher}{ExportModule}   % Teacher uses ExportModule
		\umlcompo{ExportModule}{Paper}        % ExportModule generates/manages Paper
		\umluniassoc{ExportModule}{Database}  % ExportModule interacts with Database
